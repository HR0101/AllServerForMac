...
- **視聴位置とお気に入りの共有**：Mac アプリ本体の再生も、ブラウザ UI・iPhone・Android と同じ「続きから」「お気に入り」の記録を使う。自動再生 / リピート / シャッフル / 再生速度 / 字幕・音声トラック / ピクチャインピクチャ / メディアキー / 再生中のスリープ抑止に対応（[詳細](#mac-アプリ本体の再生視聴位置お気に入り自動再生速度)）
